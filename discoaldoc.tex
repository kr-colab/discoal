...
The source code for \texttt{discoal} is available for download from \url{http://kernlab.rutgers.edu/downloads/index.html} and
download the tarball. To unpack and compile this you can use the following commands at a terminal:

\begin{verbatim}
$ tar zxvf discoal_distrb.tar.gz
$ cd discoal_distrb
$ make
\end{verbatim}
